...
THEME_NAMES = {
    ...
    # 技术方向（第二铺开）
    '技术预言': '技术预研', '协议': '协议与通信', 'GIS': 'GIS 与地图',
    '地图': 'GIS 与地图', '单点登陆和认证相关': '认证与单点登录',
    '算法': '算法与数据结构', '压力测试': '压力测试', '开源协议': '开源协议与 License',
    'license': '开源协议与 License', '人工智能': '人工智能', '负载均衡': '负载均衡',
    'Devops': 'DevOps', '高可用': '高可用', '监控': '监控', '运维': '运维',
    '破解': '其他', 'AR': '其他', '代码加密': '其他', '文件存储': '其他',
    # 阅读方向（第二铺开）
    '面试相关': '面试相关', '知识总结': '知识总结', '精彩博客': '精彩博客',
    '源码阅读': '源码阅读', '八股文': '八股文', '预读': '预读',
    '好的学习网站': '学习网站', '每日刷题': '刷题', '热门': '热门',
    '常用的': '常用',
    # 工具方向（第二铺开）
    '服务器': '服务器', '开发工具': '开发工具', '办公': '办公',
    'Mac工具': 'Mac 工具', 'VPN': 'VPN', '数据库': '数据库工具',
    '浏览器': '浏览器', '好用的工具': '好用的工具', '游戏': '游戏',
    '破解': '破解', '装机': '装机', '电视': '电视',
}
...
THEME_ORDER = {
    ...
    '技术': ['协议与通信', 'GIS 与地图', '认证与单点登录', '算法与数据结构',
             'DevOps', '大数据', '负载均衡', '压力测试', '监控', '高可用',
             '人工智能', '技术预研', '开源协议与 License', '运维', '其他'],
    '阅读': ['面试相关', '知识总结', '源码阅读', '八股文', '刷题', '学习网站',
             '精彩博客', '热门', '预读', '常用',
             '2026年', '2025年', '2024年', '2023年', '2022年', '2021年', '2020年'],
    '工具': ['开发工具', '服务器', 'Mac 工具', '数据库工具', '浏览器', '办公',
             '好用的工具', 'VPN', '装机', '阅读', '游戏', '电视', '破解'],
}
