...
const DIRECTION_ORDER = ['linux', 'nginx', 'network', 'security', 'java', 'netty', 'js', 'typescript', 'react', 'vue', 'mysql', 'postgresql', 'redis', 'mongodb', 'elasticsearch', 'distributed', 'zookeeper', 'etcd', 'seata', 'middleware', 'kafka', 'rocketmq', 'mqtt', 'rabbitmq', 'python', 'algorithm', 'ai', 'langchain', 'docker', 'kubernetes', 'git', 'tools'];
