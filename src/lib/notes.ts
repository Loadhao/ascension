...
const DIRECTION_ORDER = ['linux', 'nginx', 'tomcat', 'java', 'js', 'mysql', 'postgresql', 'redis', 'mongodb', 'elasticsearch', 'distributed', 'middleware', 'kafka', 'rocketmq', 'mqtt', 'rabbitmq', 'python', 'ai', 'docker', 'git', 'tools'];
