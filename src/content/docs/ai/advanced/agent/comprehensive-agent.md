...
- 全系列演进路线见[多 Agent 协作总览](/ai/advanced/agent/multi-agent/)
- 各机制详解：[子智能体](/ai/intermediate/agent/subagent/)、[任务系统](/ai/advanced/agent/task-system/)、[后台任务](/ai/advanced/agent/background-tasks/)、[定时调度](/ai/advanced/agent/cron-scheduler/)、[Agent 团队](/ai/advanced/agent/agent-teams/)、[团队协议](/ai/advanced/agent/team-protocols/)、[自主智能体](/ai/advanced/agent/autonomous-agents/)、[Worktree 隔离](/ai/advanced/agent/worktree-isolation/)、[MCP 协议](/ai/intermediate/agent/mcp/)
