...
[后台任务](/ai/advanced/agent/background-tasks/)让 Agent 能后台执行慢操作，
...
- 上游概念：[后台任务](/ai/advanced/agent/background-tasks/)
- 下一步：一个 Agent 不够用了，见[Agent 团队](/ai/advanced/agent/agent-teams/)
