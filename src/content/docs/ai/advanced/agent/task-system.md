...
[任务规划](/ai/intermediate/agent/todo-planning/)的 TodoWrite 是当前任务的
...
- 上游概念：[任务规划 TodoWrite](/ai/intermediate/agent/todo-planning/)
- 下一步：慢任务不阻塞主循环，见[后台任务](/ai/advanced/agent/background-tasks/)
