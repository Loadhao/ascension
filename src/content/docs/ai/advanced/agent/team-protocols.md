...
[Agent 团队](/ai/advanced/agent/agent-teams/)的队友能干活了，但协调是松散的：
...
- 上游概念：[Agent 团队](/ai/advanced/agent/agent-teams/)
- 下一步：队友自己找活干，见[自主智能体](/ai/advanced/agent/autonomous-agents/)
