...
保留[任务规划](/ai/intermediate/agent/01-todo-planning/)的最小 hook 结构和
...
（留给 [后台任务](/ai/advanced/agent/03-background-tasks/) 一章展开）。
...
- 临时工（Subagent）与常驻队友的差异见 [Agent 团队](/ai/advanced/agent/05-agent-teams/)
