...
不看屏幕也能把三次握手听完的一遍配音（通勤或复习用，逐句对应上面动画的 6 帧）：

<AlgorithmVizIsland demo="tcp-handshake-video" />
...
不看屏幕也能把四次挥手听完的一遍配音（通勤或复习用，逐句对应上面动画的 8 帧）：

<AlgorithmVizIsland demo="tcp-close-video" />
