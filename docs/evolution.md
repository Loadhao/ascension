...
### 第 127 轮（2026-09-08，第五十三次启动，内容补充模式）：MQ 顺序消费（middleware/basic/mq 第 4 篇）——分区有序原理、消费端并行矛盾、三大 MQ 实现差异。五连验证全绿，提交 66e1d08 已推送。middleware/basic/mq 4 篇（含顺序消费与延迟消息 level 修正）。
